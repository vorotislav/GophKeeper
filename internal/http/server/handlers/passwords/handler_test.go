	...
	cases := []struct {
		...
		},
		{
			...
			checkResult: func(t *testing.T, rr *httptest.ResponseRecorder) {
				...
				assert.JSONEq(t, `[{"id":1, "title":"title", "login":"login", "password":"pass", "url":"url", "note":"note", "expired_at":"0001-01-01T00:00:00Z", "created_at":"0001-01-01T00:00:00Z", "updated_at":"0001-01-01T00:00:00Z"}]`, rr.Body.String())
			},
		},
	}
